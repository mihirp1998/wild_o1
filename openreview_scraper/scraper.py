...
class Scraper:
  ...
  def scrape(self):
    ...
    unfiltered_papers_list = papers_to_list(papers)
    print(f"Number of unfiltered papers: {len(unfiltered_papers_list)}")
    ...
    print(f"Number of filtered papers: {len(papers_list)}")
    print("Saving as CSV...")
